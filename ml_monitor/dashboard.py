...
Run with: streamlit run ml_monitor/dashboard.py -- --db ml_monitor.db
"""
...
def _get_db_path() -> str:
    ...
    parser.add_argument("--db", default=os.environ.get("ML_MONITOR_DB", "ml_monitor.db"))
...
def main():
    ...
    if labeled:
        from ml_monitor.detectors.concept_drift import detect_concept_drift
